...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/css/bootstrap-datepicker.css')}}" />
    <link rel="stylesheet" href="{{asset('assets/css/css/jquery.timepicker.css')}}" />
...
<body>
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-12 col-md d-flex align-items-center">
					<p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">09129035279</a> or <span class="mailus">email us:</span> <a href="#">otuekongpes@gmail.com</a></p>
				</div>
				<div class="col-12 col-md d-flex justify-content-md-end">
					<p class="mb-0">Mon - Sat / 9:00-21:00, Sat - Sun / 10:00-20:00 </p>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Cleon's.<span>Delicacy</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a href="index.htm" class="nav-link">Home</a></li>
	...
	<footer class="ftco-footer ftco-no-pb ftco-section">
			...
			<div class="row no-gutters">
				<div class="col-md-12 text-center">
					...
					<p class="mb-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Cleon</a>
        ...
        <script src="{{asset('assets/js/js/bootstrap-datepicker.js')}}"></script>
        <script src="{{asset('assets/js/js/jquery.timepicker.min.js')}}"></script>
        <script src="{{asset('assets/js/js/scrollax.min.js')}}"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
        <script src="{{asset('assets/js/js/google-map.min.js')}}"></script>
